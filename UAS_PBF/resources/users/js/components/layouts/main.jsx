...
class Kids extends Component {
    ...
    componentDidMount() {
        document.getElementById("color").setAttribute("href", `/users/assets/css/color10.css` );
    }
    render(){
        ...
        return (
            <div>
                <Helmet>
                    <title>Mamamia | Kids Store</title>
                </Helmet>
                        ...
                        <div className="row partition2">
                            <div className="col-md-6">
                                <a href="#">
                                    <div className="collection-banner p-right text-center">
                                        <div>
                                            <img src={`/users/assets/images/kids/2.jpg`}
                            ...
                            <div className="col-md-6">
                                <a href="#">
                                    <div className="collection-banner p-right text-center">
                                        <div>
                                            <img src={`/users/assets/images/kids/1.jpg`}
